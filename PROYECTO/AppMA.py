...
from ProductDrink import ProductDrink as Drink
from ProductFood import ProductFood as Food
...
#MODULO 2######################################################################################################################################
    def regisgter(self): #todo restar entradas de tiket
        ...
        for i, race in enumerate(self.aux_races): #FIXME
        ...
        carrera=self.aux_entradas[option].race_name #FIXME
